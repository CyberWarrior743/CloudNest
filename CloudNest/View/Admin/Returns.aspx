<%@ Page Title="" Language="C#" MasterPageFile="~/View/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Returns.aspx.cs" Inherits="CloudNest.View.Admin.Returns" %>
    ...
    <div class="container">
            ...
            <div class="col-md-4">
                <div class="row">
                    <div class="col"></div>
                    <div class="col">
                         <h4 class="text-center" style="color: #8984c7">Manage GPU Returns</h4>
                        
                        <img style="width:400px; height:300px" src="../../Assets/Img/wallpaperflare.com_wallpaper (2).jpg"/>
                    </div>
                    <div class="col"></div>
                </div>
                <div class="row">
                    <div class="col">
                        <form runat="server">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Delay</label>
